...
- **诚实匹配：** 严格对照*你自己的*简历**与偏好**打分 —— 会匹配职位描述里**真正的要求**，
  而不只是技术关键词（例如 JD 要求「从 0 到 1 的产品经验」，会核对你是否真的从零做过项目；
  JD 要求「带一支 PM 团队」，会核对你是否真的做过带人管理），再看资历、地点和薪资。
  匹配度弱的职位排名自然靠后，且只对发生变化的内容重新打分。
